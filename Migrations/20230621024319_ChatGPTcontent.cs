...
{
    public partial class ChatGPTcontent : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Content", "Title", "UpdatedDate" },
                values: new object[] { "Set up folder structure. Deleted starter files. Added own HomeController. Added BlogPost class. Added own /Home/Index.cshtml. Added own _layout. Added Tagg Helper to _ViewImports", "Microblog, day one", new DateTime(2023, 6, 10, 21, 24, 40, 274, DateTimeKind.Local).AddTicks(4570) });
